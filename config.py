...
# ============== إعدادات تليجرام ==============
TELEGRAM_BOT_TOKEN = "ضع_التوكن_هنا"   # مثال: 7891234567:AAH...
TELEGRAM_CHAT_ID   = "ضع_الشات_آيدي_هنا"  # مثال: 123456789
...
MIN_PRICE        = 5.0      # أقل سعر مقبول للسهم (لتجنب أسهم البنس)
